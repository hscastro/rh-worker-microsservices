create table tb_roles (id int8 generated by default as identity, role_name varchar(255) not null, primary key (id));
...
alter table if exists tb_user_role add constraint FK6g6aaa2yginq4fp9k1tg6ls3r foreign key (role_id) references tb_roles;
